...
function Divider() {
    return (
        <div id="contact" className="bg-black">
            ...
            <form method="post" name="myemailform" action="" className="w-full max-w-4xl mt-3 text text-centerm-auto">
                ...
                <div className="md:flex md:items-center">
                    ...
                    <div className="m-auto">
                        <button className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded text-center" name="submit" type="submit">
                            Send
                </button>
                    </div>
                </div>
